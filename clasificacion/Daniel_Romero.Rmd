...
# Usé el criterio B, y no modifique el data set porque no conozco el contexto del problema y prefiero no perder ningun dato aunque este pueda no ser útil
```{r}
library("caret")
